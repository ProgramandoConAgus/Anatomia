...
<title>Medicina y Anatomia</title>
	...
	<link rel="icon" type="image/png" href="./images/logo-anato.png">
		<meta charset="utf-8" />
		<meta name="description" content="Preparando anato" />
				...
				<div class="d-flex flex-column flex-center text-center p-10">
					...
					<div class="card card-flush w-md-650px py-5">
						<div class="card-body py-15 py-lg-20">
							...
							<form class="form w-100" action="./forgot-password/send_reset_email.php" method="POST">
								<!--begin::Heading-->
								...
								<div class="fv-row mb-8">
									<input type="email" placeholder="Email" name="recoveryEmail" autocomplete="off" class="form-control bg-transparent" />
								</div>
								<!--end::Input group=-->
								<!--begin::Submit button-->
								<div class="d-grid mb-10">
									<button type="submit" class="btn btn-primary">
										...
										<span class="indicator-label">Enviar mail</span>
									</button>
								</div>
						</div>
					</div>

						...
						<div class="content flex-row-fluid" id="kt_content">
							...
							<div class="bgi-no-repeat bgi-position-center bgi-size-cover d-flex flex-column h-400px h-lg-500px">
                                ...
                                <div class="text-center">
                                    <img src="./images/estudio.png" width="50px" height="70px" alt="">
                                    </div>
									<!--begin::Title-->
									<h3 class="fs-2x fw-bold text-white text-center mb-10 mb-lg-13 my-3">Plataforma Exclusiva de Anatomía</h3>
							...
							<!--begin::Container-->
										...
										<!--begin::Separator-->
											...
											<div class="d-flex flex-stack mb-5">
												<!--begin::Title-->
												<h3 class="text-gray-900">¿Por Donde Empezar?</h3>
												<!--end::Title-->
											</div>
											<!--end::Content-->
											<!--begin::Separator-->
										...
										<div class="card-body d-flex flex-column flex-center">
											<!--begin::Heading-->
											<div class="mb-2">
												<span class="fw-bolder">Módulo Locomotor</span></h1>
												<!--end::Title-->
												<!--begin::Illustration-->
												<div class="py-10 text-center">
													<img src="./images/locomotor-removebg-preview.png" class="theme-light-show w-200px" alt="">
												</div>
												<!--end::Illustration-->
											</div>
											<!--end::Heading-->
											...
											<div class="text-center mb-1">
												<!--begin::Link-->
												<a class="btn btn-sm btn-success me-2" data-bs-target="#kt_modal_new_card" href="pantalla-cursos-clases.php?numero=<?=$numeroLocomotor?>">Comenzar</a>
												<!--end::Link-->
											</div>
											<!--end::Links-->
										</div>
										...
										<div class="card-body d-flex flex-column flex-center">
											<!--begin::Heading-->
											<div class="mb-2">
												<span class="fw-bolder">Módulo Esplacnología</span></h1>
												<!--end::Title-->
												<!--begin::Illustration-->
												<div class="py-10 text-center">
													<img src="./images/espac-removebg-preview.png" class="theme-light-show w-200px" alt="">
												</div>
												<!--end::Illustration-->
											</div>
											<!--end::Heading-->
											...
											<div class="text-center mb-1">
												<!--begin::Link-->
												<a class="btn btn-sm btn-success me-2" data-bs-target="#kt_modal_new_card" href="pantalla-cursos-clases.php?numero=<?=$numeroEspla?>">Comenzar</a>
												<!--end::Link-->
											</div>
											<!--end::Links-->
										</div>
										...
										<div class="card-body d-flex flex-column flex-center">
											<!--begin::Heading-->
											<div class="mb-2">
												<span class="fw-bolder">Módulo Neuroanatomía</span></h1>
												<!--end::Title-->
												<!--begin::Illustration-->
												<div class="py-10 text-center">
													<img src="./images/neuro-removebg-preview.png" class="theme-light-show w-200px" alt="">
												</div>
												<!--end::Illustration-->
											</div>
											<!--end::Heading-->
											...
											<div class="text-center mb-1">
												<!--begin::Link-->
												<a class="btn btn-sm btn-success me-2" data-bs-target="#kt_modal_new_card" href="pantalla-cursos-clases.php?numero=<?=$numeroNeuro?>">Comenzar</a>
												<!--end::Link-->
											</div>
											<!--end::Links-->
										</div>
